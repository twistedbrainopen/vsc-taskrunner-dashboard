...
export class TaskMatrixView {
    private readonly _reportTask: TaskConfig = {
        id: "generate-report",
    ...
    private _renderTaskButton(task: TaskConfig): string {
        return `
            <button 
                class="task-button" 
    ...
    private _renderReportSection(): string {
        return `
            <div class="report-section">
                ...
                >
                    <span class="task-icon">${getIconHtml(this._reportTask.icon)}</span>
